...
export const RICH_STEVE: Wrestler = {
  ...
  stamina: 100,
  moves: ["Shoulder Block", "Headlock", "Body Slam", "Powerbomb", "Running Splash", "Back Elbow", "Nerve Hold"],
  signatureMove: "New Money (Swinging Flatfliner) / Market Crash (Side Effect)",
  height: "6'1\"",
  weight: "340 lbs",
...
export const WRESTLERS: Wrestler[] = [
  ...
  },
  {
    ...
    role: "Manager",
    style: "Manager",
    bio: "Manager — not a wrestler. One-third of original Working Class Heroes (with Yams and Ryan Vox) before Rampage. At RPW, managed Motley Tü alongside his brother Ian Cross and Vox — until he left to manage Riot City's Most Wanted instead. When Matt Wylde crossed the ring and became Mac Mayhem, Kory joined Project Mayhem with him as Mayhem's manager. He brought Vox into Mayhem as their wildcard — Vox's pre-existing relationship with Yams was what made the home invasion possible. At The Final Shot (April 27, 2019), Kory is on Team Big Mike — but he is not a wrestler. Yams is the only actual wrestler on that side. When $teve shaved Yams' beard at Cosplayers Unite (August 18, 2018), Kory hit his limit alongside Vox. Both attacked $teve and turned face. Working Class Heroes reformed with Yams. Kory managed them as WCH through The Final Shot. The pattern holds: Steve's ego burns another set of allies.",
    stamina: 60,
    moves: ["Distraction", "Object Throw", "Foreign Object", "Low Blow"],
    signatureMove: null,
    ratings: { power: 38, speed: 40, technical: 32, toughness: 38, mic: 77, heat: 71, overall: 48 },
  },
  {
    id: "jay-cortez",
    name: "Jay Cortez",
    ...
    signatureMove: null,
    ratings: { power: 52, speed: 38, technical: 30, toughness: 55, mic: 76, heat: 74, overall: 52 },
  },
  ...
  },
  {
    ...
    signatureMove: null,
    ratings: { power: 35, speed: 38, technical: 30, toughness: 36, mic: 78, heat: 72, overall: 46 },
  },
  {
    id: "trish-adora",
    name: "Trish Adora",
  ...
  // ─── ERA 6/7 ADDITIONS ───────────────────────────────────────
  {
    ...
    signatureMove: null,
    ratings: { power: 78, speed: 65, technical: 65, toughness: 76, mic: 62, heat: 64, overall: 70 },
  },
  {
    id: "killian-mcmurphy",
    name: "Killian McMurphy",
    faction: "Project Mayhem",
    role: "Midcard",
    style: "Power",
    bio: "Brought into the Project Mayhem orbit as Mac Mayhem began distancing himself with the 'Emphasis on ME' promo. Killian is positioned as the new Mac — the power presence to replace the gap Mac's drifting is creating. Beat Ryan Vox for the RPW Open Challenge Championship. Attacked ringside with KTB at Cosplayers Unite after the Vic Ramon match, part of the Yams beard shave sequence. Brought in specifically for the Final Shot (April 27, 2019) — the culmination of the new Mayhem lineup. He and KTB are the next generation of patsys in the cycle: useful until Steve decides they aren't.",
    stamina: 80,
    moves: ["Running Clothesline", "Suplex", "Corner Splash", "Shoulder Block"],
    signatureMove: null,
    ratings: { power: 80, speed: 64, technical: 66, toughness: 78, mic: 60, heat: 62, overall: 70 },
  },
  {
    id: "big-mike",
    name: "Big Mike Scott",
    ...
    signatureMove: null,
    ratings: { power: 42, speed: 32, technical: 25, toughness: 48, mic: 88, heat: 86, overall: 52 },
  },
];
...
export const CAREER_CHAPTERS: CareerChapter[] = [
...

  {
    ...
    introCutscene: [
      {
        speaker: "NARRATOR",
        text: "The Year of Mayhem begins. 2018. Rich $teve holds the vision. Jay Cortez holds the money. Project Mayhem holds the building.",
      },
      {
        speaker: "NARRATOR",
      ...
      {
        speaker: "NARRATOR",
        text: "The plan for 2018: win the Riot Rumble contract. Use Yams' psychology against him. Never let Lars see the play before it's already running.",
      },
      {
        speaker: "Rich $teve",
        text: "This is supposed to be our company. And we are going to take back every inch of it.",
        isPromo: true,
      },
    ],
    promoGame: [
      {
        situation: "Rampage Pro Wrestling. Lars Madison has changed one of your match stipulations — a match you were supposed to dominate — to something that puts you at a disadvantage. The crowd's watching your reaction at the entrance ramp.",
        options: [
          {
            text: "Say nothing. Process. Let them see the fury through your eyes.",
            isCorrect: true,
            crowdReaction: "heat",
            feedback: "You're a schemer, not a screamer. Letting the crowd read the calculation forming on your face is more threatening than any words.",
          },
          {
            text: "LARS! YOU CAN'T DO THIS! THIS IS AN OUTRAGE!",
            isCorrect: false,
            crowdReaction: "pop",
            feedback: "You gave Lars the reaction he wanted. A complaining heel gives the authority figure power. Wrong read.",
          },
          {
            text: "Go back to the locker room. Don't give the crowd a reaction at all.",
            isCorrect: false,
            crowdReaction: "silence",
            feedback: "Disappearing reads as retreat. You need to be seen — you just need to control what they see.",
          },
          {
            text: "Smile. Nod slowly. Tell the crowd this is fine. You have contingencies.",
            isCorrect: true,
            crowdReaction: "heat",
            feedback: "The calm acceptance of a man who always has another plan is exactly what a crowd-hated heel looks like. They don't trust that smile. Good.",
          },
        ],
      },
      {
        situation: "Private conversation with Jay Cortez before a show. Lars is in the building and he's about to sanction a ruling that will block your path to the title shot. Jay is panicking.",
        options: [
          {
            text: "Jay — we need to regroup. This is supposed to be our company. We are going to take back every inch of it.",
            isCorrect: true,
            crowdReaction: "heat",
            feedback: "This is exactly the dynamic — controlled, strategic, not panicking. Jay panics. Steve recalibrates. That's the partnership.",
          },
          {
            text: "I quit. If we can't control our own GM, what are we even doing?",
            isCorrect: false,
            crowdReaction: "pop",
            feedback: "Rich $teve never quits. Ever. In 13 years, not once. He recalibrates. He regroups. He doesn't fold.",
          },
          {
            text: "Get Lars on the phone. Tell him who actually runs this company.",
            isCorrect: false,
            crowdReaction: "silence",
            feedback: "If Jay could get Lars on the phone and make him listen, he would have done it already. Lars reports to someone above Jay. This doesn't work.",
          },
          {
            text: "No worries. I'll work around it. The plan doesn't change — we just adjust the approach.",
            isCorrect: true,
            crowdReaction: "heat",
            feedback: "The mark of a real long-game player: obstruction is just friction, not a wall. You adapt. You continue. Lars is a variable, not a verdict.",
          },
        ],
      },
    ],
...

  {
    ...
    title: "Big Mike Day",
    date: "July 14, 2018",
    venue: "Warehouse — Lancaster, PA",
    city: "Lancaster, PA",
    stipulation: "The Bookstore Incident — Big Mike's 'The Weird One' Book Signing",
    historicalResult: "story",
    historicalNote: "July 14, 2018. Lancaster, PA. Rich $teve crashed Big Mike's memoir signing at Warehouse. Zero customers. He pulled out the Riot Rumble contract, mocked the book, took the candy, drank Mike's water, and left with the rest of the candy for the road. Context: by this point in 2018, $teve had already broken into Yams' house (bathtub promo filmed from Yams' own bathroom) and won the Riot Rumble contract (March 10), retained it at the Guerrero Special (April 21). The bookstore visit was July 14. Eight days later, on July 22 at an Outbreak Pro Wrestling post-show concert, Yams interrupted Steve's rap group's set with a rap battle challenge — it ended in a brawl, Steve left bloody. Steve posted the photos and vowed retribution at Infinity CosPlayers Unite (August 18). The beard shave hadn't happened yet. The Vox/Kory turn hadn't happened yet. Everyone was watching the Yams feud. Nobody was watching the lockbox.",
    matchless: true,
    introCutscene: [
      {
        speaker: "NARRATOR",
...

  {
    ...
    introCutscene: [
      ...
      {
        speaker: "NARRATOR",
        text: "Mac Mayhem is gone — distanced with the 'Emphasis on ME' promo. Vox and Kory Cross turned at Cosplayers Unite. But Steve didn't scramble. He replaced them. Killian McMurphy — who beat Vox for the Open Challenge — is the new Mac. KTB is the new Vox and Kory. The cycle turns again.",
      },
      {
        speaker: "NARRATOR",
        text: "This is the pattern. Coalition/OTCW: brought in Conrad, Bronson, used #BRUH, discarded the ones who had no more value. Kept Mac and Wrex. Added Vox. Added Kory. Now Killian. Now KTB. New patsys, same story. Steve uses everyone exactly as long as they serve the plan.",
      },
      {
        speaker: "NARRATOR",
        text: "The endgame: win the Rampage Heavyweight title from Yams. Hold both RPW Tag titles solo. Hold the Heavyweight. Three belts at the head of his own promotion. That is what all of this has always been building toward.",
      },
      {
        speaker: "Rich $teve",
        text: "Cortez is my partner tonight. I've had worse. Big Mike wants to be GM — over my dead body. This company ends the way it started: with me running it.",
        isPromo: true,
      },
    ],
    outroCutscene: {
