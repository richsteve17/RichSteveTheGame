...
export const WRESTLERS: Wrestler[] = [
  ...
  // ─── ERA 4 ADDITIONS ─────────────────────────────────────────
  {
    ...
    role: "Midcard",
    style: "Brawler",
    bio: "Came into the Rampage world with Bob Evans and Tim Hughes. Not a Project Mayhem member — a mercenary. Steve hired him specifically for the Retribution 5-on-5 (November 4, 2017). The team was Steve, Mac, Vox, Wrex, and Redwood as the hired fifth. #BRUH — Steve's actual OTCW day ones — were not on the card. Steve went outside the faction and brought in a merc instead of his own people. That decision is what caused #BRUH to turn at the Curtain Call five weeks later.",
    stamina: 72,
...
export const CAREER_CHAPTERS: CareerChapter[] = [
...

  {
    ...
    introCutscene: [
      ...
      {
        speaker: "NARRATOR",
        text: "Team Mayhem: $teve, Mac, Vox, Wrex — and Grizzly Redwood, brought in as a hired mercenary via Bob Evans and Tim Hughes. Steve was the 5th man himself. #BRUH were not on the card. Five against five. Elimination rules.",
      },
      {
        speaker: "Rich $teve",
...

  {
    ...
    introCutscene: [
      ...
      {
        speaker: "NARRATOR",
        text: "Five weeks after Retribution — where Steve was the 5th man himself, ran with Mac, Vox, and Wrex, and hired Grizzly Redwood as an outside mercenary to fill the last spot. #BRUH — his OTCW day ones, the men he brought through the Coalition and kept through every Mayhem rebuild — were not on the card at all. Sidelined in favor of a hired gun. Tonight is the consequence.",
      },
      {
        speaker: "NARRATOR",
